...
Bloom is a small selective full-screen composite after the sand pass. Its extraction threshold is deliberately above the normal sunlit sand range, so it catches the near-white reflective specks without lifting or hazing the whole bed. The bloom kernel stays small because the target is a photographic sensor/lens response around individual grains, not a general glow effect.
